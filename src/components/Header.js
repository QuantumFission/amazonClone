...
export default function Header() {
  ...
  return (
    <header>
      {/* ------top------ */}
      <div
        className='flex items-center bg-amazon_blue px-1 flex-grow py-2'>
        <div
          className=' mt-2 mx-2 flex items-center flex-grow sm:flex-grow-0'>
          <Image
            onClick={() => router.push("/")}
        ...
        <div
          className=' hidden flex-grow cursor-pointer items-center h-10 rounded-md sm:flex bg-yellow-400 hover:bg-yellow-500'>
